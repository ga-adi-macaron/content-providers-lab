...
public class StockPortfolioContract {
    public static final String AUTHORITY = "drewmahrt.generalassemb.ly.investingportfolio.StocksContentProvider";
    ...
    public static final class Stocks implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE
                + "/vnd.drewmahrt.generalassemb.ly.investingportfolio";
